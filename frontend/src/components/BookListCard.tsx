...
// titles) rather than as its own leading column.
export function BookListCard({ book }: BookListCardProps) {
  const meta = formatBookMeta(book)

  return (
    <div className="flex items-center gap-5 rounded-md border-t border-border px-2 py-3 first:border-t-0 hover:bg-accent-soft">
