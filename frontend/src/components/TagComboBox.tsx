...
// substring filter only — a caller with its own filterOption (e.g. the
// Key(s) picker's matchesKeyQuery) already handles its own matching
// semantics and isn't touched by this.
