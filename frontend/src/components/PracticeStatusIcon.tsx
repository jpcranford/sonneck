...
// One icon per status: an empty -> half -> full progression across the
// first three statuses, then an emptied hourglass for Stalled ("ran out")
// and a plain ban circle for
// Dropped. Centralized here so the Piece Details pill and Grid card badge
