      ...
      >
        ...
        >
          ...
          {/* Book Details (was "Source Details") — the book page range.
              Own collapsible section at the very end of the form, same
              "collapsed by default" posture as Copyright below it (direct
              follow-up request) — it's about where this piece lives inside
              its source book, not a fact about the piece itself the way
              every section above it is, so it doesn't need to compete with
              the piece's own bibliographic fields for early attention
              ...
              still reads first within the section. */}
          <div className="border-t border-border pt-4">
            {/* Text styling matches SectionHeading (Frontmatter/Musical
                ...
                section title that's also a clickable disclosure trigger,
                so it needs the chevron + hover affordance SectionHeading
                itself (a plain h3) doesn't. */}
            <button
              type="button"
          ...
          <div className="border-t border-border pt-4">
            {/* Text styling matches SectionHeading (Frontmatter/Musical
                ...
                Details' own trigger above uses, for the same reason: this
                is a section title that's also a clickable disclosure
                trigger, so it needs the chevron + hover affordance
